...
const transformations = [
  {
    id: 1,
    title: 'Finance.AI - Національний фінансовий асистент',
    brd: 'ФОП авторизується через Дія.Підпис, система автоматично збирає дані з ДПС (податки, доходи), Monobank (транзакції), Держказначейства (бюджетні програми) та EDR (реєстр юросіб). AI-engine аналізує фінансовий стан за квартал, категоризує витрати (транспорт, оренда, зарплати, податки), виявляє аномалії у витратах, прогнозує доходи на наступний період. Система показує фінансовий дашборд з графіками доходів/витрат, розраховує кредитний score (0-850), оцінює фінансові ризики, надає персоналізовані AI-рекомендації (оптимізація податків, економія витрат, доступні субсидії/програми підтримки). Користувач може експортувати фінансовий звіт у PDF/Excel для бухгалтера, сформувати заявку на субсидію, отримати прогноз бюджету на рік',
    icon: DollarSign,
  },
  {
    id: 2,
